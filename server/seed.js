...
/* [id, 编号, 名称, 行业, 规模, 状态] */
const CUSTOMERS = [
  ['C001', 'KH202601', '江西晨光新材料股份有限公司', '化学原料和化学制品制造业', '中型', '存量'],
  ['C002', 'KH202602', '九江华远物流有限公司', '道路运输业', '小型', '存量'],
  ['C003', 'KH202603', '萍乡金鼎机械制造有限公司', '通用设备制造业', '中型', '存量'],
  ['C004', 'KH202604', '南昌恒信电子科技有限公司', '计算机、通信和其他电子设备制造业', '小型', '新增'],
  ['C005', 'KH202605', '赣州绿源农业发展有限公司', '农、林、牧、渔专业及辅助性活动', '中型', '存量'],
  ['C006', 'KH202606', '宜春昌盛建材有限公司', '非金属矿物制品业', '小型', '存量'],
  ['C007', 'KH202607', '上饶通达汽配有限公司', '汽车制造业', '小型', '存量'],
  ['C008', 'KH202608', '吉安鑫旺纺织有限公司', '纺织业', '中型', '存量'],
  ['C009', 'KH202609', '抚州康泰医药有限公司', '批发业', '中型', '存量'],
  ['C010', 'KH202610', '景德镇陶源陶瓷有限公司', '非金属矿物制品业', '小型', '新增'],
  ['C011', 'KH202611', '新余钢联金属制品有限公司', '金属制品业', '中型', '存量'],
  ['C012', 'KH202612', '鹰潭铜都铜业有限公司', '有色金属冶炼和压延加工业', '大型', '存量']
];
